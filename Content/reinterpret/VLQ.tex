...
\begin{figure}[tbp]
  \centering
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{1Gen/HWZ100/dominantPools0}\label{fig:gen1:001:dom}}
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{1Gen/HWZ001/dominantPools0}\label{fig:gen1:010:dom}} \\
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{1Gen/HWZ010/dominantPools0}\label{fig:gen1:100:dom}}
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{1Gen/HWZ121/dominantPools0}\label{fig:gen1:121:dom}}
  \vspace*{2ex} \\
  \begin{tabular}{lll}
...
\begin{figure}[th]
  ...
  \mbox{%
    \subfloat[]{
      \includegraphics[width=0.36\textwidth]{1Gen/HWZ010/Rivet/0105/d75-x01-y01}\label{fig:gen1:wjjscan:a}}
    \quad
    \subfloat[]{
      \includegraphics[width=0.36\textwidth]{1Gen/HWZ010/Rivet/0152/d75-x01-y01}\label{fig:gen1:wjjscan:b}}
    \quad
    \subfloat[]{
      \includegraphics[width=0.36\textwidth]{1Gen/HWZ010/Rivet/0257/d75-x01-y01}\label{fig:gen1:wjjscan:c}}
    }
    \caption{ATLAS \SI{8}{\TeV} $Wjj$ forward-lepton control region leading-jet
      ...
      \protect\subref{fig:gen1:wjjscan:a} \SI{1000}{\GeV},
      \protect\subref{fig:gen1:wjjscan:b} \SI{1750}{\GeV}, and
      \protect\subref{fig:gen1:wjjscan:c} \SI{2250}{\GeV}. The rise and
      subsidence of a 90\% \CLs exclusion from a single $Wjj$ bin is seen as the
      contour passes from below \SI{1}{\TeV} to above \SI{2}{\TeV}.
...
The results for VLQs coupling to second-generation quarks for the four branching fraction scenarios is presented in Figure~\ref{fig:2gen:dom}. These exclusion maps scan betwee $\kappa=0$ and $\kappa=0.4$. The bound on the coupling is at $\kappa=0.2$ and comes from measurements of the $Z \rightarrow q\bar{q}$ couplings at LEP~\cite{Buchkremer:2013bha,ALEPH:2005ab}. 

\begin{figure}[tbp]
  \centering
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{2Gen/HWZ100/dominantPools0}\label{fig:gen2:001:dom}}
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{2Gen/HWZ001/dominantPools0}\label{fig:gen2:010:dom}} \\
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{2Gen/HWZ010/dominantPools0}\label{fig:gen2:100:dom}}
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{2Gen/HWZ121/dominantPools0}\label{fig:gen2:121:dom}}
  \vspace*{2ex}
  \begin{tabular}{llll}
    \swatch{cornflowerblue}~ATLAS $WW$ & \swatch{navy}~ATLAS $\mu$+\MET{}+jet & \swatch{cadetblue}~ATLAS $e$+\MET{}+jet\\
...
\begin{figure}[tbp]
  \centering
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{3Gen/HWZ100/dominantPools0}\label{fig:gen3:001:dom}}
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{3Gen/HWZ001/dominantPools0}\label{fig:gen3:010:dom}} \\
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{3Gen/HWZ010/dominantPools0}\label{fig:gen3:100:dom}}
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{3Gen/HWZ121/dominantPools0}\label{fig:gen3:121:dom}}
  \vspace*{2ex}
  \begin{tabular}{lll}
    \swatch{cornflowerblue}~ATLAS $WW$ & \swatch{navy}~ATLAS $\mu$+\MET{}+jet & \swatch{cadetblue}~ATLAS $e$+\MET{}+jet \\
