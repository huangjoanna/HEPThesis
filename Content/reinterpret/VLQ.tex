...
\begin{figure}[tbp]
\vspace{-0.4cm}
\subfloat[$T$ coupling to $u,d$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/1stGen/p_p____T_T.pdf}} %5000 fb
\subfloat[$T$ coupling to $c,s$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/2ndGen/p_p____T_T.pdf}} %5000 fb\\
\subfloat[$T$ coupling to $t,b$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/3rdGen/p_p____T_T.pdf}}
...
\begin{figure}[t]
    \vspace{-0.4cm}
    \subfloat[$T$ coupling to $u,d$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/1stGen/p_p____T_V.pdf}} %5000 fb
    \subfloat[$T$ coupling to $c,s$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/2ndGen/p_p____T_V.pdf}} %5000 fb\\
    \subfloat[$T$ coupling to $t,b$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/3rdGen/p_p____T_V.pdf}} %5000 fb
    \includegraphics[height=3.5cm]{Figures/VLQ/xsScans/3rdGen/cbar.pdf} %5000 fb\\
    \subfloat[$Y$ coupling to $u,d$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/1stGen/p_p____V_Y.pdf}} %5000 fb
    \subfloat[$Y$ coupling to $c,s$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/2ndGen/p_p____V_Y.pdf}} %5000 fb\\
    \subfloat[$Y$ coupling to $t,b$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/3rdGen/p_p____V_Y.pdf}} %5000 fb
    \includegraphics[height=3.5cm]{Figures/VLQ/xsScans/3rdGen/cbar.pdf} %5000 fb
...
\begin{figure}[tbp]
    \vspace{-0.4cm}
    \subfloat[$T$ coupling to $u,d$ only]{\includegraphics[width=0.31\textwidth]{Figures/VLQ/xsScans/1stGen/p_p____T_q.pdf}} %5000 fb
    \subfloat[$T$ coupling to $c,s$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/2ndGen/p_p____T_q.pdf}} %5000 fb\\
    \subfloat[$T$ coupling to $t,b$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/3rdGen/p_p____T_q.pdf}} %5000 fb
    \includegraphics[height=3.5cm]{Figures/VLQ/xsScans/3rdGen/cbar.pdf} %5000 fb \\
    \subfloat[$X$ coupling to $u,d$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/1stGen/p_p____X_q.pdf}} %5000 fb
    \subfloat[$X$ coupling to $c,s$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/2ndGen/p_p____X_q.pdf}} %5000 fb\\
    \subfloat[$X$ coupling to $t,b$ only]{\includegraphics[width=0.32\textwidth]{Figures/VLQ/xsScans/3rdGen/p_p____X_q.pdf}} %5000 fb
    \includegraphics[height=3.5cm]{Figures/VLQ/xsScans/3rdGen/cbar.pdf} %5000 fb
...
\begin{figure}[tbp]
    \vspace{-0.4cm}
    \subfloat[]{\includegraphics[width=0.45\textwidth]{Figures/VLQ/B/1200/combinedOverlay.pdf}\label{fig:BTonlyB}}
    \subfloat[]{\includegraphics[width=0.45\textwidth]{Figures/VLQ/T/1350/combinedOverlay.pdf}\label{fig:BTonlyT}}
    \raisebox{0.8cm}{\includegraphics[height=5.1cm]{Figures/BL/combinedMeshcbar.pdf}}
    \caption{Sensitivity of LHC measurements to
    \protect\subref{fig:BTonlyB}~$B$-production for $M_B =$ \unit{1200}{\GeV} and
    \protect\subref{fig:BTonlyT}~$T$-production for $M_T =$ \unit{1350}{\GeV}.
...
\begin{figure}[tbp]
  ...
  \caption{Dominant LHC analysis pools contributing to VLQ limit-setting in the
    ...
    \protect\subref{fig:gen1:121:dom}~\WZHtoo. This figure is from Reference~\cite{VLQ_contur}.}
  \label{fig:1gen:dom}
\end{figure}
...
\begin{figure}[th]
  ...
  \mbox{%
    \subfloat[]{
      \includegraphics[width=0.33\textwidth]{Figures/VLQ/1Gen/HWZ010/Rivet/0105/d75-x01-y01}\label{fig:gen1:wjjscan:a}}
    \quad
    \subfloat[]{
      \includegraphics[width=0.33\textwidth]{Figures/VLQ/1Gen/HWZ010/Rivet/0152/d75-x01-y01}\label{fig:gen1:wjjscan:b}}
    \quad
    \subfloat[]{
      \includegraphics[width=0.33\textwidth]{Figures/VLQ/1Gen/HWZ010/Rivet/0257/d75-x01-y01}\label{fig:gen1:wjjscan:c}}
    }
...
\begin{figure}[tbp]
  ...
  \caption{Dominant LHC analysis pools contributing to VLQ limit-setting in the
    ...
    \protect\subref{fig:gen2:121:dom}~\WZHtoo. This figure is from Reference~\cite{VLQ_contur}.}
  \label{fig:2gen:dom}
\end{figure}
...
\begin{figure}[tbp]
  ...
  \caption{Dominant LHC analysis pools contributing to VLQ limit-setting in the $\kappa$ vs
    ...
    and \protect\subref{fig:gen3:121:dom}~\WZHtoo. This figure is from Reference~\cite{VLQ_contur}.%
  }
  \label{fig:3gen:dom}
\end{figure}
...
$Z$ boson cross-section measurements~\cite{Sirunyan:2019bzr,Sirunyan:2018cpw}. The four-lepton pool, which was not visible in the \contur 1.2.2 scan of Figure~\ref{fig:gen2:010:dom}, now makes an appearance at low $\kappa$ between \unit{1000}{\GeV}-\unit{1250}{\GeV}. Overall, the \contur limit is more stringent. In the high mass region in particular, the increased sensitivity results in a visible dependence on $\kappa$, which was not present earlier.
...
\begin{figure}[tbp]
  \centering
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{Figures/VLQ/newm4l/1genWHZ001.pdf}\label{fig:gen1:001:newm4l}}
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{Figures/VLQ/newm4l/2genWHZ001.pdf}\label{fig:gen2:001:newm4l}} \\
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{Figures/VLQ/newm4l/3genWHZ001.pdf}\label{fig:gen3:001:newm4l}}
  \vspace*{2ex}
  \begin{tabular}{llll}
...
Figure~\ref{fig:gen1:4l} shows the \contur excluded region by the four-lepton final state pool alone in the $M_Q-\kappa$ plane for VLQs coupling to first generation quarks. The yellow and green regions are disfavoured at 95\% CL and 68\% CL respectively. The left and right plots correspond to the limit set by the pool while omitting and including the full Run II \mFourL{} measurement, respectively. In other words, the improvement in the limit seen in Figure~\ref{fig:gen1:4lnew} compared to Figure~\ref{fig:gen1:4lold} is attributed solely to the addition of the new \mFourL{} measurement. The upper limit on VLQ mass increases from \unit{1000}{\GeV} to \unit{1100}{\GeV}at low $\kappa$, and from \unit{1200}{\GeV} to over \unit{1500}{\GeV} at high $\kappa$. Without the new \mFourL{} measurement, the 95\% CL exclusion reaches $\sim 1$~\TeV, any higher and there are not enough events. Below this mass, the exclusion in Figure~\ref{fig:gen1:4lold} is driven by pair production via the strong and EM interaction, which is independent of $\kappa$. The $\kappa$ dependence in the green 68\% CL excluded region of Figure~\ref{fig:gen1:4lold} is an early sign for the 95\% CL excluded region of Figure~\ref{fig:gen1:4lnew}. The inclusion of the \unit{139}{\invfb} four-lepton measurement allows probing into higher $M_Q$, where a $\kappa$ dependence comes into play as VLQs are pair produced via the weak interaction. 
...
\begin{figure}[tbp]
    \begin{subfigure}{.55\textwidth}\centering
      \includegraphics[width=.99\linewidth]{Figures/VLQ/newm4l/1gen-d14-x01-y01.pdf} \caption{}\label{fig:gen1:rivet:4lold}
    \end{subfigure}
        \begin{subfigure}{.55\textwidth}\centering
      \includegraphics[width=.99\linewidth]{Figures/VLQ/newm4l/1gen-d04-x01-y01.pdf} \caption{}\label{fig:gen1:rivet:4lnew}
    \end{subfigure}
    \caption{\ATLAS \unit{13}{\TeV} four-lepton measurement at (a)~\unit{36.1}{\invfb} and (b)~\unit{139}{\invfb} at $M_Q=1237$~\GeV and $\kappa=0.05$. The black points are data, the red histogram is the VLQ contribution stacked on top of the data, and the green histogram is the SM prediction. In the lower insets, the ratio is shown and the yellow band indicates the significance, taking into account the statistical and systematic uncertainties on the data. The legend gives the exclusion (i.e. one minus the $p$-value) for that histogram. }
    \label{fig:gen1:4l:rivet}
\end{figure}
