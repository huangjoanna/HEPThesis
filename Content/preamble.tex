...
\usepackage{mathrsfs} % script afont
\usepackage{verbatim}
\usepackage{caption}
...
\newcommand{\BLgroup}{\Ugroup{1}\mymath{_{B-L}}\xspace}

%% VLQ
%% Physics
\newcommand{\herwig}{H\protect\scalebox{1.0}{erwig}\xspace}
...
\newcommand*{\ggZZ}{\ensuremath{gg\to Z^{(*)}Z^{(*)}}\xspace}
