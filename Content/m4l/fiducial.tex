...
\begin{itemize}
    \item Cosine of angle $\theta^{*}$, where $\theta^{*}$ is the angle between the \todo{definitely check this} lepton in the rest frame and the \Z boson in the lab frame. This angle is sensitive to the polarization of the decaying boson. This is measured for the primary and secondary lepton pair, \CTSOneTwo and \CTSThreeFour
